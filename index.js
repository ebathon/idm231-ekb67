...
function zodiac(){
    ...
    //   document.getElementsByClassName("zodiac-sub-box").innerHTML
      ...
      var audio = document.getElementById("ColeAudio");
      audio.play();
      setTimeout(function() {
        audio.pause();
      }, 15000);
    ...
    //   document.getElementsByClassName("zodiac-sub-box").innerHTML
      ...
      var audio = document.getElementById("TylerAudio");
      audio.play();
      setTimeout(function() {
        audio.pause();
      }, 15000);
    ...
    //   document.getElementsByClassName("zodiac-sub-box").innerHTML
      ...
      var audio = document.getElementById("ChanceAudio");
        audio.play();
        setTimeout(function() {
          audio.pause();
        }, 15000);
    ...
    //   document.getElementsByClassName("zodiac-sub-box").innerHTML
      ...
      var audio = document.getElementById("KanyeAudio");
      audio.play();
      setTimeout(function() {
        audio.pause();
      }, 15000);
    ...
    //   document.getElementsByClassName("zodiac-sub-box").innerHTML
      ...
      var audio = document.getElementById("50CentAudio");
      audio.play();
      setTimeout(function() {
        audio.pause();
      }, 15000);
    ...
    //   document.getElementsByClassName("zodiac-sub-box").innerHTML
      ...
      var audio = document.getElementById("UziAudio");
      audio.play();
      setTimeout(function() {
        audio.pause();
      }, 15000);
      ...
      if ((birthmonth == 8 && birthday >= 23) || (birthmonth == 9 && birthday <= 22)){
        ...
        var audio = document.getElementById("FloAudio");
        audio.play();
        setTimeout(function() {
          audio.pause();
        }, 15000);
      ...
      if ((birthmonth == 9 && birthday >= 23) || (birthmonth == 10 && birthday <= 22)){
        ...
        var audio = document.getElementById("EminemAudio");
        audio.play();
        setTimeout(function() {
          audio.pause();
        }, 15000);
      ...
      if ((birthmonth == 10 && birthday >= 23) || (birthmonth == 11 && birthday <= 21)){
        ...
        var audio = document.getElementById("DrakeAudio");
        audio.play();
        setTimeout(function() {
          audio.pause();
        }, 15000);
    ...
    if((birthmonth == 12 && birthday >= 22) || (birthmonth == 1 && birthday <= 19)){
        ...
        var audio = document.getElementById("MacAudio");
        audio.play();
        setTimeout(function() {
          audio.pause();
        }, 15000);
